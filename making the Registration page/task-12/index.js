window.addEventListener("load",()=>{
  axios.get('https://crudcrud.com/api/fb2570580d0e4d048f9853a780a9a671/appoinmentData')
  .then(res=>{
...
const displayData = (formData) => {
  ...
  formData.map((el, index) => {
    ...
    btnDelete.addEventListener('click', () => {
     ...
     axios.delete(`https://crudcrud.com/api/466d15103dde4c099257557411469f57/appoinmentData/${el._id}`)
...
form.addEventListener('submit', (e) => {
  ...
  axios.post("https://crudcrud.com/api/fb2570580d0e4d048f9853a780a9a671/appoinmentData",obj)
  .then(res=>{
    displayData([res.data]);
    console.log(res);
  })
